...
def opt_messages_to_list(
    system_message: Union[str, None], user_message: Union[str, None]
) -> List[Dict[str, str]]:
    messages = []
    if system_message:
            ...
            try:
                ...
                for item in prompt:
                    if isinstance(item, str):
                        ...
                        # For non-string items, recursively process them
                        item_md = compile_prompt_to_md(item, _header_depth=_header_depth)
                        # Add bullet point prefix to each line
