...
IMPORTANT: Select more papers rather than fewer. Even if papers seem only moderately related to your work, include them if they could potentially provide relevant context, background, or alternative perspectives. Aim to select at least 1-2 papers from each search result set unless they are completely irrelevant. Remember, it's better to have a more comprehensive bibliography than to miss potentially valuable references.
